...
- Persistent apps use the Kopiur backup component and set `APP`, `KOPIUR_SOURCE_PVC`, and `KOPIUR_CAPACITY` substitutions; new PVCs restore from `${APP}-nfs` by default via Kopiur `dataSourceRef`.
