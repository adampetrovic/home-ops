...
#
# Changelog:
#   20241001 allow setting initdb locale (you still need to modify any import_from invocations)
...
class ClusterTemplate:
    ...
    def import_from(self, name, database, user, secret, locale=None):
        ...
        # allow overriding locale for new database
        if locale:
            self.spec['bootstrap']['initdb']['localeCType'] = locale
            self.spec['bootstrap']['initdb']['localeCollate'] =  locale
